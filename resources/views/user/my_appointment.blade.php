   ...
   <div align="center" style="padding:50px"> 
    <table>
        ...
        <tr style="background-color: gray; border:1px solid white;">
            <td style="padding:10px; font-size:20px; color:white;">{{$appointment->name}}</td>
            <td style="padding:10px; font-size:20px; color:white;">{{$appointment->email}}</td>
            ...
            <td style="padding:10px; font-size:20px;  background-color: red;"><a style="color:white;" href="{{url('/appointment/cancel', $appointment->id)}}">Cancel</a></td>
        </tr>
        @endforeach
    </table>
   </div>
